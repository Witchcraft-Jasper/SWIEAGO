package com.example.myguideapplication.ui;
...
public class ItemGroup extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        jtRightIv.setFocusable(true);
        jtRightIv.setClickable(true);
        jtRightIv.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (contentEdt.isEnabled()) {

                    contentEdt.setFocusable(false);
                    ...
                    //contentEdt.setBackground(background);
                    contentEdt.requestFocus();
                    //jtRightIv.startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.view_transant));
                    jtRightIv.startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.view_translate));
                }
            }
        });
    }
...
//        contentEdt.setFocusable(true); //设置输入框是否可以编辑
